...
export default function MotorPrivateQuote() {
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-gray-700 font-semibold mb-2">
                      Driver Occupation <span className="text-orange-500">*</span>
                    </label>
                    <input
                      type="text"
                      ...
                      required
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:border-orange-500 focus:outline-none transition-colors"
                      placeholder="Enter driver occupation"
                    />
                  </div>

                  <div>
                    <label className="block text-gray-700 font-semibold mb-2">
                      Location/Residence <span className="text-orange-500">*</span>
                    </label>
                    <input
                      type="text"
                      ...
                      required
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:border-orange-500 focus:outline-none transition-colors"
                      placeholder="Enter location/residence"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-gray-700 font-semibold mb-2">
                      Average km travelled per month <span className="text-orange-500">*</span>
                    </label>
                    <input
                      type="number"
                      name="averageKmPerMonth"
                      value={formData.averageKmPerMonth}
                      onChange={handleInputChange}
                      required
                      min="0"
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:border-orange-500 focus:outline-none transition-colors"
                      placeholder="Enter average km per month"
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white border-2 border-gray-200 rounded-xl p-6 shadow-lg sticky top-8">
              ...
              <div className="text-center">
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-3">Motor Private Insurance</h4>
